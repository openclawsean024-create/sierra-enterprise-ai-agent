...
const comparisonFeatures = [
  ...
  { feature: 'Widget 嵌入', starter: false, pro: true, enterprise: true },
...
const faqs = [
  {
    q: '可以試用嗎？',
    a: '是的，Starter 方案完全免費，您可以立即開始使用。如果需要更高階功能，我們也提供 14 天 Pro 方案試用。',
  },
  {
    q: '如何取消？',
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {pricingPlans.map((plan, i) => (
            ...
            >
              ...
              <a
                href={plan.name === 'Enterprise' ? 'mailto:support@sierra-aiagent.com?subject=Enterprise方案詢問' : '/login'}
